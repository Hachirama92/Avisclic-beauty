document.addEventListener('DOMContentLoaded', () => {
    ...
    // ⭐⭐⭐ INFORMATIONS POUR FORMSPREE BEAUTY (NAILS) ⭐⭐⭐
    // L'URL Formspree fournie pour la version Beauty :
    const FORMSPREE_ACTION_URL = 'https://formspree.io/f/mwpqobjv'; 
    
    // Noms des champs pour Formspree (pour la Beauty) :
    ...
    // ⭐⭐⭐ FIN DES INFOS FORMSPREE BEAUTY (NAILS) ⭐⭐⭐
    ...
    submitLowScoreButton.addEventListener('click', async () => { 
        ...
        try {
            ...
            if (response.ok) { 
                console.log("Feedback envoyé à Formspree Beauty avec succès !");
                feedbackLowScore.classList.add('hidden');
